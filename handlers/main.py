...
async def handle_help(query, context: ContextTypes.DEFAULT_TYPE):
    text = (
        "ℹ️ *Помощь по боту*\n\n"
        "Я — финансовый помощник, который помогает:\n"
        "✅ Отслеживать доходы и расходы\n"
        "✅ Управлять накоплениями\n"
        "✅ Анализировать финансы по категориям и периодам\n"
        "✅ Получать актуальный курс валют\n\n"
        
        "📌 *Как пользоваться:*\n"
        "Нажимайте кнопки меню и следуйте подсказкам.\n"
        "Для отмены действия используйте кнопку *↩️ Отмена*.\n\n"
